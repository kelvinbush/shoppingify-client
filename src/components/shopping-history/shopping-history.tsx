...
import { getShoppingHistory, HistoryItem, historySelector } from '../../features/history';
    ...
    return (
      <div className={styles.history}>
        ...
        <div className={styles.history_scroll}>
          {groupedHistory && groupedHistory.map((hist) => (
            <div className={styles.history__container}>
              ...
              {hist.items.map((item) => (
                <div className={styles.history__list_card}>
                  ...
                  <p className={styles.history__list_card_date}>{formatDate(item.created_at)}</p>
                  <div
